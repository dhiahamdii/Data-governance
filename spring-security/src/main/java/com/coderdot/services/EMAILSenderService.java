...
public class EMAILSenderService {
    ...
    public void sendNewMail(String to) throws MessagingException {
        ...
        MimeMessageHelper helper = new MimeMessageHelper(message, true, "UTF-8");
            ...
            helper.setTo(to);
            helper.setSubject("Welcome to DataGov");
            String htmlContent =( "<div class=\"\"><div class=\"aHl\"></div><div id=\":m7\" tabindex=\"-1\"></div><div id=\":n3\" class=\"ii gt\" jslog=\"20277; u014N:xr6bB; 1:WyIjdGhyZWFkLWY6MTc5Mjc5ODQ3MzkyNDA3Mjk3OSJd; 4:WyIjbXNnLWY6MTc5Mjc5ODQ3MzkyNDA3Mjk3OSJd\"><div id=\":my\" class=\"a3s aiL msg-290301008761648123\"><div class=\"adM\">\n" +
                    "  \n" +
                    "    \n" +
                    "    \n" +
                    "    \n" +
                    ...
                    "<div>we are all really excited to welcome you to our team</div>\n" +
                    "</div>\n" +
                    "</td>\n" +
                    "</tr>\n" +
                    "<tr>\n" +
                    ...
                    "<div>&nbsp;</div>\n" +
                    "<div><strong>Your email :</strong>"+ to +"</div>\n" +
                    "<div><strong>Your Password :</strong> password123</div>\n" +
                    "</div>\n" +
                    "</td>\n" +
                    "</tr>\n" +
                    "<tr>\n" +
